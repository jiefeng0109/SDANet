...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--dataset', default='Dubai',
                                 help='Duabi | LasVegas | SanDiego')
        self.parser.add_argument('--exp_id', default='Dubai')
        ...
        # model
        self.parser.add_argument('--arch', default='hourglass', help='hourglass')
        self.parser.add_argument('--head_conv', type=int, default=-1,
                                 help='conv layer channels for output head'
                                      '0 for no conv layer'
                                      '-1 for default setting: '
                                      '64 for resnets and 512 for dla.')
        ...
        self.parser.add_argument('--lr_step', type=str, default='100',
        ...
        self.parser.add_argument('--seg_weight', type=float, default=0.5,
    ...
    def parse(self, args=''):
        ...
        if opt.head_conv == -1:  # init default head_conv
            opt.head_conv = 512 if 'dla' in opt.arch else 64
        ...
        opt.exp_dir = os.path.join(opt.root_dir, 'experiments')
    ...
    def update_dataset_info_and_set_heads(self, opt, dataset):
        ...
        opt.heads = {'seg': 1, 'hm_center': 1, 'hm_all': 1, 'wh': 2}
