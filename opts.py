...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--dataset',
                                 help='Duabi | LasVegas | cd ')
        self.parser.add_argument('--exp_id', default='sea-master')
    ...
    def update_dataset_info_and_set_heads(self, opt, dataset):
        ...
        # opt.heads = {'seg': 1, 'wh': 2 if not opt.cat_spec_wh else 2 * opt.num_classes,
        #              'hm_center': 1, 'hm_all': 1}
